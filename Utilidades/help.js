...
\`ban unban kick block setprefix anuncio sorteio setsugest addemoji addvip addcargo say clear\`\n\n<a:seta:882102474264154215>| DIVERSÃO
\`cafune tapa abraço beijar ship sikera conquista bolsonaro laranjo mcinfo mchead mcbody pato gato cachorro passarinho coelho escanor\`\n\n<a:seta:882102474264154215>| AVENTURA:
\`create-avatar open battle explorar chop eat buy shop bag av use\`\n\nGostou de mim? então me adicione em seu servidor clicando [Aqui](https://discord.com/api/oauth2/authorize?client_id=844227895819894794&permissions=287636319703&scope=bot)\n\nQuer me ajudar a crescer mais rápido e poder entreter mais pessoas? Vote em mim basta clicar [Aqui](https://top.gg/bot/844227895819894794)\n\nQuer ficar Atualizado sobre Novos comandos e novas atualização? Entre em Meu [Servidor de Suporte](https://discord.gg/u65cgdFHSN)**`)
