...
return message.inlineReply(`**<:erro:858615784771551252>| Espere ${time.hours}h ${time.minutes}m ${time.seconds}s Para realizar um Crime novamente!**`);
  }
...
if(caiu == 'Preso') { message.inlineReply(embed)
