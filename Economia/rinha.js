...
module.exports.run = async function(client, message, args, database, prefix) {
  ...
  let amount = args[0]
  if(!amount || amount < 10) return message.reply(`**<:erro:858615784771551252>| Informe uma quantia após o comando!**`)
  if(isNaN(amount)) return message.reply(`**<:erro:858615784771551252>| Informe uma quantia válida**`)

  if(amount > money) return message.reply(`**<:erro:858615784771551252>| Você não não possui essa quantia na sua Carteira!**`)
